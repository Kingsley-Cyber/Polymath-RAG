...
6. `docs/wiki/plans/DOCUMENT-SEMANTIC-INDEX-V1-PLAN.md` — the **next-phase plan of record** (document semantic index + parent map + vocabulary bridge; slices S0–S16), with `docs/wiki/plans/DOCUMENT-SEMANTIC-INDEX-V1-START-HERE.md` as its coding-agent hook. Current slice: **S0-S3 done (11.129-11.132: admission, ParentSkeleton, map compiler, token packer — the deterministic core); S4 SQL durability next.**
