...
00. **`docs/wiki/reports/2026-09-09/START-HERE.md` — the NEWEST handoff + CURRENT operating state (session bootstrap 2026-09-09).** Control-plane repair LANDED (register 11.185; branch `architecture/evidence-first-v5` @ `f1112ce`, 4 commits AHEAD of origin, unpushed). Cinema pMAP backfill STOPPED; the only remaining gate is a **bounded, owner-authorized Groq live probe** (quota topology) → benchmark → canary. Read the numbered pack `01_…`–`09_…` in that folder. Execution authority = `RETRIEVAL-MIGRATION-DEPENDENCY-V1.md` (S-slices) + `FINAL-RETRIEVAL-ROUTING-SYNTHESIS-V1.md` (P-phases) + `PLAN-AUTHORITY-REGISTER.md`; note **`RAG_PIPELINE_FINISH_PLAN.md` does NOT exist** in this repo.
