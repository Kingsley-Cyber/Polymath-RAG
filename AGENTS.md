...
6. `docs/wiki/plans/DOCUMENT-SEMANTIC-INDEX-V1-PLAN.md` — the **next-phase plan of record** (document semantic index + parent map + vocabulary bridge; slices S0–S16), with `docs/wiki/plans/DOCUMENT-SEMANTIC-INDEX-V1-START-HERE.md` as its coding-agent hook. Current slice: **S0 done (11.129); S1 deterministic ParentSkeleton done (11.130); S2 map compiler next.**
