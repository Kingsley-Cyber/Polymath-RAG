...
| mistralai/mistral-small-24b-instruct-2501 @ OpenRouter | model@host | **PASS — fallback for 2603** | quick grade A 0.83 in 15.8 s; 09-01 canary PASS 18.5 f/1Kw, 8/8 enrichment; superseded by mistral-small-2603 (newer, better, multi-provider) — keep as the documented fallback slug, $0.05/$0.08 |
| mistralai/ministral-3b-2512 @ OpenRouter | model@host | **CANDIDATE — cheap enrichment lane (quick grade B 0.796)** | enrichment 8/8 terms, gist 1.0, 8.8 s total; extraction recall 0.5/0.75, relations weak; $0.10/$0.10, 131K ctx. Needs the 8-chunk canary before a pin slot |
