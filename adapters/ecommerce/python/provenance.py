...
def corpus_contribution(state: dict) -> dict:
    ...
    # LEGACY (< v2.2.0) state only: a synthesized answer's citations counted as a use of the row. An EvidencePacket
    # RETRIEVES rows — being in a packet is not being cited, so packets add nothing here.
