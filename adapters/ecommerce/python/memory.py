...
_NODE_TYPES["corpus_answers"] = "CORPUS_ANSWER"                  # LEGACY (< v2.2.0) state only: a synthesis, never evidence
_NODE_TYPES["corpus_packets"] = "CORPUS_EVIDENCE_PACKET"         # docs/22 (v2.2.0)
...
_NODE_TYPES.update({"latent_structures": "LATENT_STRUCTURE", "corpus_observations": "CORPUS_OBSERVATION"})   # docs/26
