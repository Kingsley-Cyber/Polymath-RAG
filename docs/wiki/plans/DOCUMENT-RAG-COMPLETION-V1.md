...
| S6 | Part C concept routing: selection + global / home doors; neighbour door for GRAPH (one hop) — **the owner redirected SEE ALSO (2026-09-24): it widens the IDEA, it never picks books. SEEALSO-BLEND-V1 (11.475, ON) replaced the 11.472 book hop**: the question's documents' see-also lines, blended with the question, search passages corpus-wide; item-level select + the global door stay in the atom store (lane G) | flag-gated; fixture 1 reach; D4 check (do the profile routes supply the concepts?) |
