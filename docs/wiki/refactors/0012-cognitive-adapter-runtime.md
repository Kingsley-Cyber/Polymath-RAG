...
| E2 | migration `0061_adapter_runs.sql`; store/service; 7 MCP tools + /adapter routes; `adapter_step_worker`; `polymath.knowledge_brief`; crash-resume proven live | DONE (supervised slot + production bounce pending) | 11.260 — 10 substrate/MCP tests, live restart test |
