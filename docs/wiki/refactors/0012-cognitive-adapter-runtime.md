...
| E2 | migration `0061_adapter_runs.sql`; store/service; 7 MCP tools + /adapter routes; `adapter_step_worker` (supervised slot); `polymath.knowledge_brief`; crash-resume proven live | DONE (production bounce pending) | 11.260, 11.263 |
