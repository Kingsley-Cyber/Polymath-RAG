...
status: complete
status_note: "Steps 2-4 live since 09-07; step 6 became lanes 11.156 / 11.161 / 11.294. Phase B (QUERY_READY requires the profile) is S13 / S14, the owner's flip. (was: implemented (steps 2–4 of 6; rollout phase A — non-blocking, dormant until the fleet is booted with the new slot))"
register: 11.126
