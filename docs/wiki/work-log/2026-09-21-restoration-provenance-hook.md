...
- (11.398) The owner's `SEMANTIC_EXPLORATION_MEMORY_INTEGRATION.md` admitted byte-identical under `docs/migration/`; its §33 implement-now list is the matrix above, its defer list is untouched.
