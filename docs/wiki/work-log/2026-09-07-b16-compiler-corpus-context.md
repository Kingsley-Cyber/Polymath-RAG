...
status: complete
status_note: "Retired by PROFILE-SCOUT-P5B-WIRING (11.294, owner decision 11.287); rank_documents / select_titles / titles_knobs are left uncalled. (was: implemented (effect gate met on the named case; latency gate missed; dense synthesis arm partial))"
register: 11.122
