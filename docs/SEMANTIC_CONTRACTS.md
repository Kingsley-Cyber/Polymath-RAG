...
| predicate rule pack | `core-predicates-v1.5.0.yaml`, byte-frozen (SPOKEN-RELATION-ADAPTER-V1: `created` object signature gains Technology, shadow-qualified; supersedes v1.4.0/v1.3.0, which remain loadable for pinned replay) |
