...
**EXPERIMENTAL PHASE 2026-09-22 — GNN-RETRIEVAL-V1: implemented + qualified on branch `experiment/gnn-retrieval` (worktree `../pmv4-gnn`, `5f65984` + `f461b83`), NOT merged, NOT live. Handoff with the exact remaining steps: `docs/wiki/reports/2026-09-22/GNN-RETRIEVAL-V1-HANDOFF.md` (on that branch). Verdict D + C — keep experimental.**
