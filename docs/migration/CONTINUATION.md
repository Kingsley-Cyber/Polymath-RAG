...
| 4 Trail correctness (§11) | TRAIL: A46 (governance, ADR-069 Accepted, HR6 node admitted) **COMMITTED `6fa0d84`** on `codex/r1-semantic-restoration`; HR6 (production) NOT started — patch + scripts in `~/PolymathRuntime/handoff/trail-adr-069/` | §11.7 (1–6) proven pre-acceptance (6 / 6 + 27 / 27); A46 governance PASS, architecture 276 / 276 | A46 VERIFIED in Trail's own gate; HR6 pending | HR6 commit → Polymath re-pin (`restoration/trail-repin`) → live |
